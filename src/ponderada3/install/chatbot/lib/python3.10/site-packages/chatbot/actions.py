...
def go_to_secretaria(point):
    print(f"Indo para a secretaria: {point_dict['ponto 1']}")

def go_to_laboratorio(point):
    print(f"Indo para o laboratório: {point_dict['ponto 2']}")

def go_to_biblioteca(point):
    print(f"Indo para a biblioteca: {point_dict['ponto 3']}")
