...
class Translater():
    ...
    def record(self, input_path, duration=10, sample_rate=44100):
        print("Olá ! Tudo bem ?")
        print("Estou iniciando sua gravação, então cuidado, estou te ouvindo !")
        ...
        print("Fim da Gravação, ja pode fofocar sem perigo !")
